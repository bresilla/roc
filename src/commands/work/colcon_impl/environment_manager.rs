...
"#);
        ...
        for (key, value) in &self.env_vars {
            match key.as_str() {
                "CMAKE_PREFIX_PATH" | "AMENT_PREFIX_PATH" | "PATH" | "LD_LIBRARY_PATH" | "DYLD_LIBRARY_PATH" | "PYTHONPATH" => {
                    // These are PATH-like variables that need special handling
    ...
    fn generate_batch_script(&self) -> String {
        ...
        // Add environment variable sets
        for (key, value) in &self.env_vars {
            match key.as_str() {
                "CMAKE_PREFIX_PATH" | "AMENT_PREFIX_PATH" | "PATH" | "PYTHONPATH" => {
