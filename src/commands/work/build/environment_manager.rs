...
impl EnvironmentManager {
    ...
    pub fn generate_setup_script(&self, output_path: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    fn generate_bash_script(&self) -> String {
        ...
        script.push_str(r#"_roc_prepend_path() {
    local var_name="$1"
    local new_path="$2"
...
mod tests {
    ...
    fn test_path_update() {
        ...
        assert_eq!(env_mgr.get_env_var("TEST_PATH"), Some(&"/test/path".to_string()));
    }
}
