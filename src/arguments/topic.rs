...
pub fn cmd() -> Command {
    Command::new("topic")
        ...
        .subcommand(
            Command::new("delay")
            .about("Delay/pause processing for a topic for a specified duration")
            .aliases(["d", "pause", "sleep"])
            .arg_required_else_help(true)
            .arg(
                Arg::new("topic_name")
                .help("Name of the ROS topic to delay (e.g. '/chatter')")
                .required(true)
                .value_name("TOPIC_NAME")
            )
            .arg(
                Arg::new("duration")
                .help("Duration to delay (e.g. '5s', '1.5m', '300ms', '2h')")
                .required(true)
                .value_name("DURATION")
            )
            .arg(
                ...
                .short('v')
                .long("verbose")
                .help("Show verbose output with countdown and details")
                .action(ArgAction::SetTrue)
            )
        )
}